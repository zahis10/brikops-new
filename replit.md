...
-   **InnerBuildingPage**: A focused building workspace for mobile at `/projects/:projectId/buildings/:buildingId` with a sticky header, 3-tab work switcher (דירות/קומות, ליקויים, בקרת ביצוע), KPI strip, and collapsible floor → apartment hierarchy.
