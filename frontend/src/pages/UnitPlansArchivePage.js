...
const UnitPlansArchivePage = () => {
  ...
  const handleRestore = async () => {
    ...
    try {
      await unitPlanService.restore(projectId, unitId, restoreTarget.id);
  ...
  if (effectiveLabel) subtitleParts.push(`דירה ${formatUnitLabel(effectiveLabel)}`);
...
export default UnitPlansArchivePage;
