...
const ProjectPlansPage = () => {
  ...
  // BATCH H.1 — bulk upload state at page level (open + default
  // discipline). Internal file list / progress / results live in
  // <BulkPlanUploadModal> via useState there.
  ...
  // BATCH H.1 — bulk upload handlers + state moved to
  // <BulkPlanUploadModal>. This page passes uploadFn + onUploadComplete
  // and otherwise stays uninvolved.
    ...
    <div className="min-h-screen bg-slate-50 overflow-x-hidden" dir="rtl">
            ...
            <div className="space-y-4">
              <div>
                ...
                {uploadFile ? (
                  ...
                  <div className="flex gap-2">
                    <label htmlFor="plan-file-pick" className="flex-1 flex flex-col items-center justify-center gap-1 py-4 border-2 border-dashed border-slate-300 rounded-xl text-sm text-slate-500 cursor-pointer hover:border-amber-400 hover:text-amber-600 transition-colors">
      ...
      {canManage && (
        <BulkPlanUploadModal
          ...
          showFloorField={true}
          floorsList={allFloors}
          uploadFn={(file, discipline, opts) =>
            projectPlanService.upload(projectId, file, discipline, opts)
          }
